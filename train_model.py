...
openai.api_key = "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"
...
if __name__ == '__main__':
    ...
    file_name = "binlang/train_data_final.jsonl"
    uploaded_file = upload_file(file_name)

    logger.info(uploaded_file)
    job = openai.FineTuningJob.create(training_file=uploaded_file.id, model="gpt-3.5-turbo") #hyperparameters={"n_epochs":15})
